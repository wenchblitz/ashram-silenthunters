...
{
    wp_enqueue_style('bxstyle', '/wp-content/themes/silenthunters/bx_styles.css');
    wp_enqueue_script('bxscript', '/wp-content/themes/silenthunters/jquery.bxSlider.min.js', array('jquery'));
}
...
function newgravatar ($avatar_defaults) {  
    $myavatar = get_bloginfo('template_directory') . '/images/NoAvatar.jpg';  
		...
		<?php if (1==$comment->user_id) { ?>
            <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
                <div id="comment-<?php comment_ID(); ?>">
                    <div class="author-comment vcard">
                        <div class="iavatar">
							<figure><?php echo get_avatar( $comment, 75 ); ?></figure>
                        </div>
                        
                        <div class="icomment">                     
                            <div class="comment-meta commentmetadata">
                            	<strong class="author-name"><?php comment_author_link() ?></strong>&nbsp;<?php _e('says: '); ?><?php edit_comment_link('Edit','',''); ?>
